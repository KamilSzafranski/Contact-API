export const createEmailTemp = (user, id) => {
  return `
                                            ...
                                            <tr>
                                              ...
                                              >
                                                ...
                                                <table
                                                  ...
                                                  width="100%"
                                                  style="table-layout: fixed"
                                                  data-muid="c64a9089-8df2-4f79-95fb-d9bec2019dd3"
                                                >
                                                  <tbody>
                                                    <tr>
                                                      <td
                                                      ...
                                                      >
                                                        <img
                                                          ...
                                                          src="http://cdn.mcauto-images-production.sendgrid.net/28a9fa8194b69f59/cc208e0d-c914-4636-95d5-867450853166/256x256.png"
                                                        />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                ...
                                                <table
                                                  ...
                                                  width="100%"
                                                  style="table-layout: fixed"
                                                  data-muid="9438ac5c-5f8d-49f1-b0d4-39f6a3a732cf"
                                                        ...
                                                        >
                                                          <tbody>
                                                            <tr>
                                                              ...
                                                              >
                                                                <a
                                                                  href="http://localhost:3000/api/users/verify/${id}"
                                                                  style="
